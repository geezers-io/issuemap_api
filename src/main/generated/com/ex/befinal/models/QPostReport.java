...
public class QPostReport extends EntityPathBase<PostReport> {
    ...
    private static final long serialVersionUID = -1248390705L;
    ...
    public QPostReport(Class<? extends PostReport> type, PathMetadata metadata, PathInits inits) {
        ...
        this.tragetPost = inits.isInitialized("tragetPost") ? new QPost(forProperty("tragetPost"), inits.get("tragetPost")) : null;
    }
