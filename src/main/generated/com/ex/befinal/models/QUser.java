...
public class QUser extends EntityPathBase<User> {
    ...
    public final ListPath<LikeAndDislike, QLikeAndDislike> likeAndDislikes = this.<LikeAndDislike, QLikeAndDislike>createList("likeAndDislikes", LikeAndDislike.class, QLikeAndDislike.class, PathInits.DIRECT2);
